...
public abstract class GameTimer {
    ...
    /**
     * Creates a new instance of the GameTimer class with a default duration of
     * 1 second
     */
    public GameTimer() {
        this(1, false);
    ...
    /**
     * Sets the duration to a new value on the next call to reset. Allows for
     * updating the duration properly from onComplete method
     *
    ...
    /**
     * Return the amount of time in seconds the GameTimer should run for before
     * completing.
     *
     * @return targetTime
     */
     ...
     *
     * @param resetFromLastEndTime GameTimer should subtract the targetTime from
     * the previously elapsed time of the timer.
     */
    ...
    /**
     * Sets the interpolation to apply to the percent complete returned by
     * getPercentComplete()
     *
     * @param interpolation
     */
    ...
    /**
     * For use with or without managed GameTimers. Enables auto restart of the
     * timer after calling onComplete.
     *
     * @param autoRestart
     */
    ...
    /**
     * Returns if the GameTimer will automatically reset and restart after
     * calling onComplete.
     *
     * @return
     */
